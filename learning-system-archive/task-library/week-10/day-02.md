...
> 适用卡点：当本周主问题需要“数据模型设计”相关能力、实验或证据时选择。
...
1. 设计 Session 字段：id、title、text、summary、createdAt。
2. 设计 QA 字段：question、answer、createdAt。
3. 写一个样例数据。
...
- 本仓库：cs-foundations-integration.md 的数据库基础部分
- SQLAlchemy Docs - Unified Tutorial：https://docs.sqlalchemy.org/en/20/tutorial/
